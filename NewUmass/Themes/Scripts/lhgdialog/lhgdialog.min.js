...
(function (a, b, c) {
    ...
    j = b.document,
    k = "JDG" + +(new Date),
    l = '<table class="ui_border"><tbody><tr><td class="ui_lt"></td><td class="ui_t"></td><td class="ui_rt"></td></tr><tr><td class="ui_l"></td><td class="ui_c"><div class="ui_inner"><table class="ui_dialog"><tbody><tr><td colspan="2"><div class="ui_title_bar"><div class="ui_title" unselectable="on"></div><div class="ui_title_buttons"><a class="ui_min"  title="\u6700\u5c0f\u5316"><b class="ui_min_b"></b></a><a class="ui_max"  title="\u6700\u5927\u5316"><b class="ui_max_b"></b></a><a class="ui_res"  title="\u8fd8\u539f"><b class="ui_res_b"></b><b class="ui_res_t"></b></a><a class="ui_close"  title="\u5173\u95ed(esc\u952e)">\u00d7</a></div></div></td></tr><tr><td class="ui_icon"></td><td class="ui_main"><div class="ui_content"></div></td></tr><tr><td colspan="2"><div class="ui_buttons"></div></td></tr></tbody></table></div></td><td class="ui_r"></td></tr><tr><td class="ui_lb"></td><td class="ui_b"></td><td class="ui_rb"></td></tr></tbody></table>',
    m,
    n = function (a, b, c) {
        var d = a.length;
        for (; b < d; b++) {
